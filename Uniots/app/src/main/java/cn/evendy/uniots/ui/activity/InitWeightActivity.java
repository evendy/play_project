 ...
 * Created by evendy .
 */
public class InitWeightActivity extends BaseActivity {
    private View next_step;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_init_weight);
        initViews();
    ...
    private void verifyInputInfo() {
        startActivity(new Intent(getContext(), InitBornActivity.class));
    }
}
